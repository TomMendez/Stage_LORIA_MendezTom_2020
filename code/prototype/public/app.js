...
var app = (function () {
    function app() {
        ...
        this.traiterMessage = function (data) {
            var e_1, _a;
            if (this.num === 0) {
                this.num = data.num;
        ...
        this.envoyerMessageDirect = function (numMessage, numDest) {
            var e_3, _a;
            var toPG = new Map();
            try {
                for (var _b = __values(this.PG), _c = _b.next(); !_c.done; _c = _b.next()) {
        ...
        this.actualDonnees = function (nS) {
            var e_4, _a;
        ...
        this.pingProcedure = function (numCollab) {
