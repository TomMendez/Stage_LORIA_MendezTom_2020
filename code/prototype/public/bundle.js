...
var ui = (function () {
    ...
    ui.prototype.actualCollaborateurs = function (collaborateurs) {
        ...
        try {
            for (var collaborateurs_1 = __values$1(collaborateurs), collaborateurs_1_1 = collaborateurs_1.next(); !collaborateurs_1_1.done; collaborateurs_1_1 = collaborateurs_1.next()) {
                var _b = __read$1(collaborateurs_1_1.value, 2), key = _b[0], value = _b[1];
                if (key === this.num) {
